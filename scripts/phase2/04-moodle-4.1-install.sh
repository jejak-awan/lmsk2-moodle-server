...
# =============================================================================
# Phase 2: Moodle 4.1 Installation
# =============================================================================
# Version: 1.0
# Author: jejakawan007
# Description: Moodle 4.1 installation untuk LMSK2-Moodle-Server
# =============================================================================
...
# Script information
SCRIPT_NAME="Phase 2: Moodle 4.1 Installation"
SCRIPT_VERSION="1.0"
...
# Moodle 4.1 specific settings
MOODLE_VERSION="4.1"
MOODLE_DOWNLOAD_URL="https://download.moodle.org/releases/latest401/moodle-latest-401.tgz"
MOODLE_REQUIRED_PHP_VERSION="8.0"
MOODLE_REQUIRED_MYSQL_VERSION="5.7"
...
log_message() {
    ...
    # Write to log file
    echo "[$timestamp] [$level] $message" >> "/var/log/lmsk2/phase2-moodle-4.1.log"
...
check_requirements() {
    ...
    local required_extensions=("mysqli" "curl" "xml" "zip" "gd" "intl" "mbstring" "soap" "ldap" "imagick" "redis")
    ...
    if [[ $available_space -lt 2 ]]; then
        print_error "Insufficient disk space. Available: ${available_space}GB, Required: 2GB+"
        exit 1
    else
...
# =============================================================================
# Moodle 4.1 Installation
# =============================================================================

# Download Moodle 4.1
download_moodle() {
    print_section "Downloading Moodle 4.1"
    
    # Create temporary directory
    mkdir -p "$TEMP_DIR"
    cd "$TEMP_DIR"
    
    print_info "Downloading Moodle 4.1 from: $MOODLE_DOWNLOAD_URL"
    
    if wget -q --show-progress "$MOODLE_DOWNLOAD_URL" -O "moodle-4.1.tgz"; then
        print_success "Moodle 4.1 downloaded successfully"
    else
        print_error "Failed to download Moodle 4.1"
        exit 1
    fi
    
    # Verify download
    if [[ -f "moodle-4.1.tgz" ]]; then
        local file_size=$(du -h "moodle-4.1.tgz" | cut -f1)
    ...
    log_message "SUCCESS" "Moodle 4.1 download completed"
}

# Extract Moodle 4.1
extract_moodle() {
    print_section "Extracting Moodle 4.1"
    
    cd "$TEMP_DIR"
    
    print_info "Extracting Moodle 4.1..."
    
    if tar -xzf "moodle-4.1.tgz"; then
        print_success "Moodle 4.1 extracted successfully"
    else
        print_error "Failed to extract Moodle 4.1"
        exit 1
    fi
    ...
    log_message "SUCCESS" "Moodle 4.1 extraction completed"
}

# Install Moodle 4.1
install_moodle() {
    print_section "Installing Moodle 4.1"
    ...
    # Copy Moodle files
    print_info "Copying Moodle 4.1 files..."
    ...
    print_success "Moodle 4.1 installed successfully"
    log_message "SUCCESS" "Moodle 4.1 installation completed"
}
...
create_moodle_config() {
    print_section "Creating Moodle 4.1 Configuration"
...
// Additional settings for Moodle 4.1
...
EOF
    ...
    print_success "Moodle 4.1 configuration created"
    log_message "SUCCESS" "Moodle 4.1 configuration completed"
}
...
# Setup database
setup_database() {
    print_section "Setting Up Database for Moodle 4.1"
...
# =============================================================================
# Moodle 4.1 Installation via CLI
# =============================================================================

# Install Moodle via CLI
install_moodle_cli() {
    print_section "Installing Moodle 4.1 via CLI"
    ...
    print_info "Installing Moodle 4.1 via CLI..."
    ...
    if php admin/cli/install.php \
        ...
        print_success "Moodle 4.1 CLI installation completed"
    else
        print_error "Moodle 4.1 CLI installation failed"
        exit 1
    fi
    
    log_message "SUCCESS" "Moodle 4.1 CLI installation completed"
}
...
# Configure Moodle 4.1 settings
configure_moodle_settings() {
    print_section "Configuring Moodle 4.1 Settings"
    
    cd "$MOODLE_DIR"
    
    # Configure Moodle settings
    print_info "Configuring Moodle 4.1 settings..."
    ...
    print_success "Moodle 4.1 settings configured"
    log_message "SUCCESS" "Moodle 4.1 settings configuration completed"
}
...
# Verify installation
verify_installation() {
    print_section "Verifying Moodle 4.1 Installation"
    ...
    if curl -s -o /dev/null -w "%{http_code}" "${LMSK2_DOMAIN:-http://localhost/moodle}" | grep -q "200"; then
        print_success "Moodle 4.1 is accessible"
    else
        print_warning "Moodle 4.1 accessibility check failed"
    fi
    ...
    print_success "Moodle 4.1 installation verification completed"
    log_message "SUCCESS" "Moodle 4.1 installation verification completed"
}
...
main() {
    ...
    log_message "INFO" "Starting Moodle 4.1 installation"
    ...
    print_section "Moodle 4.1 Installation Complete"
    print_success "Moodle 4.1 installation completed successfully!"
    print_info "Log file: /var/log/lmsk2/phase2-moodle-4.1.log"
    ...
    log_message "SUCCESS" "Moodle 4.1 installation completed successfully"
}

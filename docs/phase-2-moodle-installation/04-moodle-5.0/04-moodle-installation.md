...
Dokumen ini menjelaskan proses instalasi Moodle 5.0, termasuk download, extract, konfigurasi, dan setup initial settings.
...
# Download Moodle 5.0
wget https://download.moodle.org/releases/latest/moodle-5.0-latest.tgz

# Verify download
ls -la moodle-5.0-latest.tgz
```
...
```ini
; OPcache Configuration for Moodle 5.0
opcache.enable = 1
...
- [Moodle 5.0 Installation](https://docs.moodle.org/500/en/Installation)
- [Moodle CLI Installation](https://docs.moodle.org/500/en/Installation_via_command_line)
- [Moodle Configuration](https://docs.moodle.org/500/en/Configuration_file)
